...
gulp.task('site-injectCSS', ['site-styles'], () => {
    /*inject bower css*/
    return gulp.src('app/views/layouts/web/**/header.html').pipe(wiredep({directory: './public/assets/site/bower_components', bowerJson: require('../public/assets/site/bower.json'), ignorePath: '../../../../../public/'})).pipe(inject(gulp.src(['public/tmp/site/styles/main.css'], {read: false}), {
        name: 'Main',
        addRootSlash: false,
...
gulp.task('admin-injectCSS', ['admin-styles'], () => {
    /*inject bower css*/
    return gulp.src('app/views/layouts/admin/**/header.html').pipe(wiredep({directory: './public/assets/admin/bower_components', bowerJson: require('../public/assets/admin/bower.json'), ignorePath: '../../../../../public/'})).pipe(inject(gulp.src(['public/tmp/admin/styles/main.css'], {read: false}), {
        name: 'Main',
        addRootSlash: false,
        transform: function(filePath, file, i, length) {
            var newPath = filePath.replace('public/', '');
